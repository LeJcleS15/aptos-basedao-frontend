        ...
        <div class="relative max-w-7xl mx-auto py-8 sm:py-16 px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-8 lg:grid lg:grid-cols-2 lg:gap-8">
                ...
                <div class="mt-8 lg:mt-0">
                    ...
                    <div class="mt-5 prose prose-amber text-gray-500 mx-auto lg:max-w-none lg:row-start-1 lg:col-start-1 text-justify pr-5">
                        <p>BaseDAO DAO is a MVP prototype of a crowdfunding smart contract comprising both the Flexible (Keep-It-All) crowdfunding model and the Fixed (All-Or-Nothing) crowdfunding model.</p>
                        ...
                        <p>With the implementation of BaseDAO DAO, I hope that this would lead to a higher number of successful projects started on the Aptos blockchain driven by an ever-growing supportive community.</p>

                        <h3>Goals</h3>
                        <p>For this MVP, my focus is to first establish a proof-of-concept for decentralised crowdfunding on the Aptos blockchain and establish an outline of the BaseDAO DAO white paper.</p>
                        ...
                        <p>The BaseDAO DAO will allow members to decide the focus and direction of the decentralised crowdfunding platform.</p>
                        ...
                        <p>BaseDAO DAO will progressively move from a one-man-operation to become primarily community-led to collectively decide on new crowdfunding projects, manage members, and distribute any internal funds raised.</p>
                        ...
                        <p>Similar to Indiegogo, BaseDAO project owners have the flexibility to decide whether their crowdfunding project will be based on either the Flexible (KIA) model or the Fixed (AON) model.</p>
