            ...
            <div class="mt-12 w-full mx-auto">
                ...
                <div id="show_all_daos" class="flex flex-col rounded-lg overflow-hidden w-full">
                    ...
                    <div class="w-full mx-auto grid gap-8 lg:grid-cols-3 pb-6">
                        ...
                        <div class="flex flex-col rounded-lg shadow-lg overflow-hidden hover:shadow-lg hover:shadow-amber-600 transition duration-300">
                           ...
                           <div class="flex-1 bg-amber-100 pt-3 p-6 flex flex-col justify-between ">
                              <div class="flex-1">
                                 <p class="text-xl font-semibold showcase_text_gray_900 mt-2"><a href="{{ route('show_dao', [$dao->dao_type, $dao->dao_id])}}" class="hover:underline">{{ $dao->name}}</a></p>

                                 <p class="mt-3 text-sm text-gray-600 text-justify">{{ \Illuminate\Support\Str::words($dao->description, 50, '...') }}</p>
